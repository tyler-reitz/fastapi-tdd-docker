...
def test_create_summaries_invalid(test_app):
...
def test_read_incorrect_id(test_app, monkeypatch):
    async def mock_get(id):
        return None
...
def test_update_summary(test_app, monkeypatch):
    test_request_payload = {"url": "https://foo.bar/", "text": "updated"}
...
@pytest.mark.parametrize(
    ...
    [
        [
            999,
            {"url": "https://foo.bar/", "text": "updated!"},
            404,
            "Summary not found",
        ],
        [
...
def test_udpate_summary_invalid(
